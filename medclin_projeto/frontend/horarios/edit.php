    ...
    <?php foreach($data as $d):?>
        <form action="" enctype="multipart/form-data" method="POST" autocomplete="off">
            <div class="row">
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        <label for="email2">Nome do horário</label>
                        ...
                        <small id="emailHelp2" class="form-text text-muted">Nós nunca compartilharemos seu e-mail com ninguém.</small>
                    </div>  
                </div>
            ...
            <div class="card-action">
                <button type="submit" name="upd_horari" class="btn btn-success">Adicionar</button>
