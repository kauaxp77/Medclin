  ...
  while($r = $sentencia->fetchObject()){
   ...
   <?php if(count($data)>0):?>
        <?php foreach($data as $d):?>
               ...
               <small id="emailHelp2" class="form-text text-muted">Nunca compartilharemos isso com ninguém..</small>
                    </div>  
                  </div> 
                ...
                while($row=$stmt->fetch(PDO::FETCH_ASSOC))
             {
               ...
               <small id="emailHelp2" class="form-text text-muted">Nunca compartilharemos isso com ninguém.</small>   
                  ...
                  <div class="row">
                    <div class="col-md-6 col-lg-6">
                     <div class="form-group">
                       <label for="email2">Área novo</label>
                  ...
                  <div class="col-md-6 col-lg-6">
                     <div class="form-group">
                       <label for="email2">Médico novo</label>
                 ...
                 <div class="card-action">
                         <button type="submit" name="upd_appoi" class="btn btn-success">Adicionar</button>
