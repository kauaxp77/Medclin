             ...
             <div class="col-md-12">
                <div class="card">
                   <div class="card-header">
                    ...
                    <a href="#addRowModal" class="btn btn-primary btn-round ml-auto" data-toggle="modal">NOVO</a>
...
<?php if(count($data)>0):?>
          ...
          <td><?php echo date('d/m/Y', strtotime($d->dates)) ?></td>
          ...
          <td>
       <?php    if($d->estado==1)  { ?> 
          <span class="text-success pl-3"><strong>Aceita</strong></span>
               <?php  }   else {?> 
     ...
     <?php    if($d->estado==1)  { ?> 
          ...
          <button onclick="location.href='../citas/edit.php?id=<?php echo $d->codcit ?>'" class="btn btn-link btn-primary btn-lg"  title="" data-original-title="Editar Tarefa">
          <i class="fa fa-edit"></i>
          </button>

          <button onclick="location.href='../citas/delete.php?id=<?php echo $d->codcit ?>'" class="btn btn-link btn-danger btn-lg" title="" data-original-title="Excluir Tarefa">
          <i class="fa fa-times"></i>
          </button>
          </div>
               <?php  }   else {?> 
                <button onclick="location.href='../citas/info.php?id=<?php echo $d->codcit ?>'" class="btn btn-link btn-info btn-lg" title="" data-original-title="Informações da Tarefa">
    ...
    <?php endif; ?>   
     ...
     <script >
          $(document).ready(function() {
               ...
               var action = '<td> <div class="form-button-action"> <button type="button" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Editar Tarefa"> <i class="fa fa-edit"></i> </button> <button type="button" data-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="Remover"> <i class="fa fa-times"></i> </button> </div> </td>';
