          ...
          <ul class="breadcrumbs">
           ...
           <div class="row">
               ...
               <div class="card-header">
                    <div class="card-title">Cancelar</div>
               </div>  
               <div class="card-body">
               <?php 
               ...
               <form action="" enctype="multipart/form-data" method="POST"  autocomplete="off">
                 <div class="row">
                  <div class="col-md-12 col-lg-12">
                    ...
                    <label for="email2">tem certeza que deseja cancelar a consulta?</label>
                    <input type="hidden" name="appoid" value="<?php echo $d->codcit  ?>">
                    </div>  
                  </div>    
                 </div> 
                 <div class="card-action">
                         <button type="submit" name="delete_appoin" class="btn btn-success">Cancelar consulta?</button>
