     ...
     <div class="page-header">
          ...
          <div class="row">
               ...
               <div class="card-header">
                    <div class="card-title">Atualizar</div>
               </div>  
               <div class="card-body">
               <?php 
...
if(isset($_POST['upd_doct'])){
    // Verifique se o campo 'estado' está presente no formulário
    if(isset($_POST['estado'])){
        // Obtenha o ID do médico do formulário
        $id = $_POST['doctid'];

        // Obtenha o estado do médico do formulário
        $estado = $_POST['estado'];

        // Assuming $connect is your database connection object
        $stmt = $connect->prepare("UPDATE medclin.doctor SET estado = :estado WHERE coddoc = :id");
               ...
               <form action="" enctype="multipart/form-data" method="POST"  autocomplete="off">
                 ...
                 <div class="row">
                  <div class="col-md-12 col-lg-12">
                    ...
                    <label for="email2">CRM do médico</label> <button type="button" id="buscar" class="btn btn-icon btn-round btn-dark">
                         <i class="fab fa-discourse"></i>
                         </button>
                    <input type="text" required maxlength="8"  onKeypress="if  event.returnValue = false;" id="documento" class="form-control" name="dnidoct" value="<?php echo $d->dnidoc  ?>" placeholder="Enter Email">
...
<div class="row">
  <div class="col-md-6 col-lg-6">
    <label for="email2">Genero do médico</label>
  ...
  <div class="col-md-6 col-lg-6">
    <label for="email2">data de nascimento do médico</label>
     <input type="date" required  class="form-control"  name="nacdoc" value="<?php echo $d->fechanaci  ?>" placeholder=" paciente">
     <small id="emailHelp2" class="form-text text-muted">Nunca compartilharemos seu e-mail com ninguém.</small> 
  </div>   
</div>
...
<div class="row">
   <div class="col-md-6 col-lg-6">
    <label for="email2">Email do médico</label>
     <input type="text" required  class="form-control"  name="coomed" value="<?php echo $d->correo  ?>" placeholder=" doutor">
     <small id="emailHelp2" class="form-text text-muted">Nunca compartilharemos seu e-mail com ninguém.</small> 
  </div>
  <div class="row">
  <div class="col-md-6 col-lg-6">
     <label for="email2">ESTADO DO MÉDICO </label>
...
<div class="card-action">
     <button type="submit" name="upd_doct" class="btn btn-success">ADICIONAR</button>
