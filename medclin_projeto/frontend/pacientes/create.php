     ...
     <div class="page-header">
       ...
       <div class="row">
               ...
               <div class="card-header">
                    <div class="card-title">Criar perfil</div>
               </div>  
               <div class="card-body">
               <?php 
...
<div class="row">
  <div class="col-md-6 col-lg-6">
     ...
     <input type="text" required id="nombres" style="color: black;" class="form-control" onkeypress="return soloLetras(event)" name="nompac" value="<?php echo $d->nombrep  ?>" disabled placeholder="Insira o nome do paciente">
  ...
  <div class="col-md-6 col-lg-6">
     <label for="email2">Sobrenome do paciente</label>
     <input type="text" required id="apellidoPaterno" style="color: black;" class="form-control" onkeypress="return soloLetras(event)" name="apepac" value="<?php echo $d->apellidop  ?>" disabled placeholder="Insira o sobrenome do paciente">
     <small id="emailHelp2" class="form-text text-muted">Nunca compartilharemos seu email com ninguém.</small>   
  </div>                    
</div>
...
<div class="row">
  <div class="col-md-6 col-lg-6">
    <label for="email2">Nome de usuário do paciente</label>
    <input type="text" required name="usnam" class="form-control" placeholder="Insira o nome de usuário">
     <small id="emailHelp2" class="form-text text-muted">Nunca compartilharemos seu email com ninguém.</small>      
  </div> 

  <div class="col-md-6 col-lg-6">
    <label for="email2">Senha do paciente</label>
    <input type="password" required  name="usclav"  class="form-control" placeholder="Insira a senha">
     <small id="emailHelp2" class="form-text text-muted">Nunca compartilharemos seu email com ninguém.</small>      
  </div>   
</div>
...
<div class="row">
  <div class="col-md-6 col-lg-6">
    <label for="email2">Cargo do paciente</label>
  ...
  <div class="col-md-6 col-lg-6">
    ...
    <select class="form-control" name="espa" required disabled style="color: black;">
          <option value="1" style="color: black;">Ativo</option>
     </select>
     <small id="emailHelp2" class="form-text text-muted">Nunca compartilharemos seu email com ninguém.</small>      
  </div>   
</div>
...
<div class="card-action">
  <button type="submit" name="add_prof" class="btn btn-success">Adicionar</button>
