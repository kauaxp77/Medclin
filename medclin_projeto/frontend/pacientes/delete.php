                                    ...
                                    <li>
                                        <div class="user-box">
                                            ...
                                            <div class="u-text">
                                                ...
                                                <p class="text-muted"><?php echo ucfirst($_SESSION['email']); ?></p><a
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title">Apagar</div>
                                </div>
                                <div class="card-body">
                                    <?php 
   ...
   ?>
                                    ...
                                    <form action="" enctype="multipart/form-data" method="POST" autocomplete="off">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <label for="email2">Tem certeza que deseja desmarcar a consulta
                                                        ?</label>


                                                    <input type="hidden" name="custid"
                                                        value="<?php echo $d->codpaci  ?>">
                                        ...
                                        <div class="card-action">
                                            <button type="submit" name="delete_custome"
                                                class="btn btn-success">Desmarcar</button>
