    ...
    <?php foreach($data as $d): ?>
        <form action="" enctype="multipart/form-data" method="POST" autocomplete="off">
            <div class="row">
                <div class="col-md-12 col-lg-12">
                    <div class="form-group">
                        <label for="email2">Nome da especialidade</label>
                        <input type="text" required class="form-control" name="namees" value="<?php echo $d->nombrees ?>" placeholder="Digite o nome">
            ...
            <div class="card-action">
                <button type="submit" name="upd_speciality" class="btn btn-success">Adicionar</button>
               ...
               <footer class="footer">
                    <div class="container-fluid">
                         ...
                         <div class="copyright ml-auto">
                              2018, made with <i class="fa fa-heart heart text-danger"></i> by kauã
                         </div>                   
                    </div>
               </footer>
          </div>
