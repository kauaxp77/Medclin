        ...
        <?php foreach($data as $d):?>
               <form action="" enctype="multipart/form-data" method="POST"  autocomplete="off">
                 ...
                 <div class="row">
                  <div class="col-md-12 col-lg-12">
                    ...
                    <label for="email2">Nova senha</label>
                    <input type="password" required class="form-control" name="newuser" placeholder="Insira nova senha">
               ...
               <small id="emailHelp2" class="form-text text-muted">Nunca compartilharemos seu email com ninguém.</small>
                 ...
                 <div class="card-action">
                         <button type="submit" name="upd_pass" class="btn btn-success">Adicionar</button>
