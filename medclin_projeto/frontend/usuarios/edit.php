                                   ...
                                   <ul class="dropdown-menu dropdown-user animated fadeIn">
                                        <div class="dropdown-user-scroll scrollbar-outer">
                                             ...
                                             <li>
                                                  ...
                                                  <div class="dropdown-divider"></div>
                                                  <a class="dropdown-item" href="../salir.php">Encerrar sesion</a>
                                             </li>
                                        </div>
                                   </ul>
                              </li>
        ...
        <?php foreach($data as $d):?>
               <form action="" enctype="multipart/form-data" method="POST"  autocomplete="off">
                 ...
                 <div class="row">
                  <div class="col-md-6 col-lg-6">
                    ...
                    <input type="text" required class="form-control" name="namees" value="<?php echo $d->nombre  ?>" placeholder="Insira Email">
               ...
               <small id="emailHelp2" class="form-text text-muted">Nunca compartilharemos seu e-mail com ninguém.</small>
                  ...
                  <div class="col-md-6 col-lg-6">
                    ...
                    <input type="text" required class="form-control" name="nameusua" value="<?php echo $d->usuario  ?>" placeholder="Insira Email">
               ...
               <small id="emailHelp2" class="form-text text-muted">Nunca compartilharemos seu e-mail com ninguém.</small>
                 ...
                 <div class="row">
                    ...
                    <select class="form-control" name="usucarg">
                         <option value="1" <?php if ($cargo_atual == 1) echo 'selected'; ?>>Administrador</option>
                         <option value="3" <?php if ($cargo_atual == 3) echo 'selected'; ?>>Recepcionista</option>
                         <!-- <option value="2" <?php if ($cargo_atual == 2) echo 'selected'; ?>>Outro Cargo </option> -->
                    </select>
                    <small id="emailHelp2" class="form-text text-muted">Nunca compartilharemos seu e-mail com ninguém.</small>
                    </div>
                  ...
                  <div class="col-md-6 col-lg-6">
                    ...
                    <input type="email" required class="form-control" name="emaiusu" value="<?php echo $d->email  ?>" placeholder="Insira Email">
               ...
               <small id="emailHelp2" class="form-text text-muted">Nunca compartilharemos seu e-mail com ninguém.</small>
                 ...
                 <div class="card-action">
                         <button type="submit" name="upd_user" class="btn btn-success">Adicionar</button>
