          ...
          <ul class="breadcrumbs">
            ...
            <div class="row">
               ...
               <div class="card-header">
                    <div class="card-title">deletar</div>
               </div>  
               <div class="card-body">
               <?php 
               ...
               <form action="" enctype="multipart/form-data" method="POST"  autocomplete="off">
                 ...
                 <div class="row">
                  <div class="col-md-6 col-lg-6">
                    ...
                    <label for="email2">Você tem certeza de que deseja excluir o registro?</label>
                 ...
                 <div class="card-action">
                         <button type="submit" name="delet_user" class="btn btn-success">Apagar</button>
